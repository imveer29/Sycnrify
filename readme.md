...
Syncrify is a real-time collaborative document editing web application built using the MERN stack (MongoDB, Express.js, React, Node.js), Socket.IO for real-time communication, and Quill as the text editor.
...
Quill, a powerful and customizable WYSIWYG editor, is integrated into Syncrify to provide a seamless real-time editing experience. Users can see live updates as collaborators edit the document.
...
Follow these steps to run Syncrify locally:

1. **Clone the repository:**

   ```bash
   git clone https://github.com/your-username/Syncrify.git
   cd Syncrify
   ```
